namespace SpriteKind {
    ...
    export const Armetion = SpriteKind.create()
    export const Leaf = SpriteKind.create()
    export const Armament = SpriteKind.create()
}
...
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`miMosaico`, function (sprite, location) {
    tiles.setWallAt(location, false)
    tiles.setTileAt(location, assets.tile`transparency16`)
    my4 = sprites.create(assets.tile`miMosaico7`, SpriteKind.Leaf)
    tiles.placeOnTile(my4, location)
    sprites.destroy(sprite)
})
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`miMosaico1`, function (sprite, location) {
    tiles.setWallAt(location, false)
    tiles.setTileAt(location, assets.tile`transparency16`)
    m = sprites.create(assets.tile`myTile`, SpriteKind.Material)
    tiles.placeOnTile(m, location)
    sprites.destroy(sprite)
})
...
controller.right.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    [img`
        ...
        f e f . . f f 7 e d d d d d f . 
        f e f . f 6 7 6 7 f f f f f . . 
        f e f f 7 7 7 7 7 6 7 f . . . . 
        . f f 7 7 7 6 f 7 f f 6 f . . . 
        . . f 6 6 7 7 f 6 f f 7 f . . . 
        . . . f 7 f f b d f b d f . . . 
        . . . f d b b d d c d d f . . . 
        . . . f f f f f f f f f . . . . 
        `,img`
        ...
        f e f . c f f 7 7 e d d d d f . 
        f e f . f 6 7 7 6 f f f f f f . 
        f e f f 7 7 7 7 7 7 6 f f f f . 
        . f f 7 7 7 6 f 7 f d d f d d f 
        . . f 6 6 7 7 f 6 f b d f b d f 
        ...
        f e f . . f e 7 e d c d d d d c 
        f e f . . f f 7 7 e d c c c f . 
        f e f . f 6 7 7 6 f f f f f . . 
        . f f f 7 7 7 7 7 7 6 f . . . . 
        . . f 7 7 7 7 f 6 7 f 7 f f . . 
        . . f 6 6 7 f f f 7 6 f f 6 f . 
        ...
        f e f . . f f 6 7 d c d d d f . 
        f e f . f 6 7 7 7 6 d f f f . . 
        . f f f 7 7 7 7 7 7 7 f . . . . 
        . . f f b 6 7 6 7 7 f f . . . . 
        . . f f d d c 7 6 f f 6 f . . . 
        . . . . f f f c d d b d d f . . 
        . . . . . f f d d d c d d f . . 
        . . . . . . f f f f f f f . . . 
        `,img`
        ...
        . . . c d b e e d d d d e e d c 
        . . . c d b e e d d c d d d d c 
        . . . . c f e 7 e d d c c c c c 
        . . . . . f f 7 7 e d d d d f . 
        . . . . f 7 7 6 7 f f f f f . . 
        f f . f 6 7 7 7 7 6 f f . . . . 
        f e . f 7 7 f 7 7 f 7 6 f . . . 
        f e . f 7 6 7 f 6 7 f 7 7 f . . 
        f e f f 7 f b b f b d f d b f . 
        f f f f 6 b d d f d d f d d f . 
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`miMosaico2`, function (sprite, location) {
    if (true) {
        ...
        [img`
            ...
            . f d d d d e e b f f . . . . . 
            . . f f f f f 7 b 6 7 f . . . . 
            . . . . f f 7 6 7 7 6 7 f . f f 
            . . . f e e f 7 6 f b 7 f . e f 
            . . f e e f 7 7 f 6 7 7 f . e f 
            . f b d f d b f b b f 6 f f e f 
            . f d d f d d f d d b 6 f f f f 
            . . f f f f f f f f f f f f f . 
            `,img`
            . . . . f f f f f . . . . . . . 
            . . . f e e e e e f . . . . . . 
            ...
            c d e e d d d d e e b d c . . . 
            c d d d d d d d e e b d c . . . 
            c c c c c d d e b e f c . . . . 
            . f d d d d e e b f f . . . . . 
            . . f e e e f f 7 7 7 f . . . . 
            . . f f f f f 7 6 7 b 6 f . f f 
            . . f d b f 6 7 f f 7 6 f . e f 
            . f f d d f 7 f f 6 7 7 f . e f 
            . f f f f f f e 7 7 f 7 f f e f 
            . f d d f e e e d d b 6 f f f f 
            . . f f f f f f f f f f f f f . 
            `,img`
            . . . . . f f f f f . . . . . . 
            . . . . f e e e e e f . . . . . 
            ...
            . c c d d d d d d d e d f f f . 
            . c d c c c c d d d e d f b d f 
            . . c d d d d d d e e f f d d f 
            . . . c d d d d b e f f 6 f f f 
            . . . . f f f 7 b f b 7 7 f . . 
            . . . . f 7 7 6 7 7 7 6 f f f . 
            . . . f 6 7 6 7 7 6 f f f e f . 
            . . f f 7 b 6 7 f f f f f e f . 
            . f b d f 6 7 f b b f f f e f . 
            . f d d f 7 6 f d d b f f f f . 
            . f f f f f f f f f f f f f . . 
            `,img`
            . . . . . f f f f f . . . . . . 
            . . . . f e e e e e f . . . . . 
            ...
            . c d c d d d d d d d e f f . . 
            . c d d c c c c d d d e f f f f 
            . . c d d d d d d d e f f b d f 
            . . . c d d d d b e f f f d d f 
            . . . . f f f e b f 7 6 6 f f f 
            . . . . f 7 7 6 7 7 6 7 f f f . 
            . . . f b 7 6 7 b 7 f f f e f . 
            . . f f 7 7 7 7 f f f f f e f . 
            . f b d f 6 6 f b b f f f e f . 
            ...
            c d e e d d d d e e b d c . . . 
            c f f d d d d d e e b d c . . . 
            f d d f e f f f e e e f . . . . 
            f d d f e e e f f f f f . . . . 
            f f f f f e e b 7 7 f f . f f . 
            . f f f 7 f f e 6 6 f f . e f . 
            . f b d f 7 f f b b f f f e f . 
            . f d d f e 6 f d d b f f e f . 
            . f f f f f f f f f f f f f . . 
            `,img`
            . . . . f f f f f . . . . . . . 
            . . . f e e e e e f . . . . . . 
            ...
            c d e e d d d d e e b d c . . . 
            c d d d d d d d e e b d c . . . 
            c f f f f b b d e e f c f . . . 
            . f b d f f f e e e e f . . . . 
            . f d d f 6 f f f e e f . . . . 
            . . f f f 6 7 7 b f f f . f f . 
            . . f 6 7 f 7 6 b 7 f f . e f . 
            . f f 7 b 7 f f f f f f f e f . 
            . f b d f 7 7 f b b f f f e f . 
            . f d d f f 6 7 d d b f f f f . 
            . f f f f f f f f f f f f f . . 
            `],
        100,
        false
        ...
        tiles.setWallAt(location, false)
        tiles.setTileAt(location, assets.tile`transparency16`)
        my_sprite_3 = sprites.create(assets.tile`myTile1`, SpriteKind.Armetion)
        tiles.placeOnTile(my_sprite_3, location)
        sprites.destroy(my_sprite_3, effects.fire, 200)
    }
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Armetion, function (sprite, otherSprite) {
    DANGEROUS += 1
    sprites.destroy(otherSprite)
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Armament, function (sprite, otherSprite) {
    Plome += 1
    sprites.destroy(otherSprite)
})
...
controller.down.onEvent(ControllerButtonEvent.Pressed, function () {
    if (controller.down.isPressed() && controller.up.isPressed()) {
        if (Laser > 0) {
            ...
            Projectile_laserr = sprites.createProjectileFromSprite(img`
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . 2 . 
                . . . . . . . . . . . . . 2 . . 
                . . . . 4 . . . . . . 2 4 . . . 
                ...
                . . . . . . . . . 2 2 2 2 2 . . 
                4 5 4 . . . . . . 2 2 2 4 2 . 4 
                5 4 5 2 2 . 4 2 2 2 2 2 2 2 . 4 
                4 5 4 2 2 2 2 2 2 2 4 2 2 2 4 2 
            ...
            Projectile_laserr.setFlag(SpriteFlag.GhostThroughWalls, false)
            Projectile_laserr.vx = 200
            Laser += -1
        } else {
            if (Plome > 0) {
                animation.runImageAnimation(
                ...
                projectile2 = sprites.createProjectileFromSprite(img`
                    ...
                    . . . . . . . . . . . . . . . . 
                    `, mySprite, 100, 0)
                projectile2.setFlag(SpriteFlag.GhostThroughWalls, false)
                projectile2.vx = 200
                Plome += -1
            }
        }
...
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`miMosaico0`, function (sprite, location) {
    tiles.setWallAt(location, false)
    tiles.setTileAt(location, assets.tile`transparency16`)
    mySprite2 = sprites.create(assets.tile`miMosaico7`, SpriteKind.Material)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile6`, function (sprite, location) {
    simplified.gravity_jump(mySprite, -333)
    animation.runImageAnimation(
    mySprite,
    [img`
        . . . . f f f f f . . . . . . . 
...
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    [img`
        ...
        . f d d d d d e 7 f f . . f e f 
        . . f f f f f 7 6 7 6 f . f e f 
        . . . . f 7 6 7 7 7 7 7 f f e f 
        . . . f 6 f f 7 f 6 7 7 7 f f . 
        . . . f 7 f f 6 f 7 7 6 6 f . . 
        . . . f d b f d b f f 7 f . . . 
        . . . f d d c d d b b d f . . . 
        . . . . f f f f f f f f f . . . 
        `,img`
        ...
        . f d d d d e 7 7 f f c . f e f 
        . f f f f f f 6 7 7 6 f . f e f 
        . f f f f 6 7 7 7 7 7 7 f f e f 
        f d d f d d f 7 f 6 7 7 7 f f . 
        f d b f d b f 6 f 7 7 6 6 f . . 
        ...
        c d d d d c d e 7 e f . . f e f 
        . f c c c d e 7 7 f f . . f e f 
        . . f f f f f 6 7 7 6 f . f e f 
        . . . . f 6 7 7 7 7 7 7 f f f . 
        . . f f 7 f 7 6 f 7 7 7 7 f . . 
        . f 6 f f 6 7 f f f 7 6 6 f . . 
        ...
        . f d d d c d 7 6 f f . . f e f 
        . . f f f d 6 7 7 7 6 f . f e f 
        . . . . f 7 7 7 7 7 7 7 f f f . 
        . . . . f f 7 7 6 7 6 b f f . . 
        . . . f 6 f f 6 7 c d d f f . . 
        . . f d d b d d c f f f . . . . 
        . . f d d c d d d f f . . . . . 
        . . . f f f f f f f . . . . . . 
        `,img`
        ...
        c d e e d d d d e e b d c . . . 
        c d d d d c d d e e b d c . . . 
        c c c c c d d e 7 e f c . . . . 
        . f d d d d e 7 7 f f . . . . . 
        . . f f f f f 7 6 7 7 f . . . . 
        . . . . f f 6 7 7 7 7 6 f . f f 
        . . . f 6 7 f 7 7 f 7 7 f . e f 
        . . f 7 7 f 7 6 f 7 6 7 f . e f 
        . f b d f d b f b b f 7 f f e f 
        . f d d f d d f d d b 6 f f f f 
        . . f f f f f f f f f f f f f . 
        `],
    100,
...
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`miMosaico2`, function (sprite, location) {
    tiles.setWallAt(location, false)
    tiles.setTileAt(location, assets.tile`transparency16`)
    my_sprite_3 = sprites.create(assets.tile`transparency16`, SpriteKind.Armetion)
    tiles.placeOnTile(my_sprite_3, location)
...
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`bounce`, function (sprite, location) {
    tiles.setWallAt(location, false)
    tiles.setTileAt(location, assets.tile`transparency16`)
    mySprite2 = sprites.create(assets.tile`transparency16`, SpriteKind.Material)
    tiles.placeOnTile(mySprite2, location)
    sprites.destroy(sprite)
})
...
let Projectile_laserr: Sprite = null
...
let String2 = 0
let Plome = 0
game.splash("Hola,bienvenido a Monskill, un juego que trata de........")
game.splash("Monk, un monito normal, adiestrado para la guerra, lucho y combatió hasta sus heridas dejar marcadas, el cual,en el curso de la guerra , a su campamento militar le tiraron una bomba nuclear,. Todos murieron,escepto el . Ahora,unos plátanos radioactivos le persiguen en busca y captura,para MATARLO...                                     Es la guerra,")
info.setLife(3)
Plome += 4
String2 += 5
Craft += 5
...
music.play(music.stringPlayable("F G E D F G E E ", 120), music.PlaybackMode.LoopingInBackground)
if (daño > 0) {
    daño = 0
    info.changeLifeBy(-1)
}
Banana = sprites.create(img`
    ...
    `, SpriteKind.Enemy)
Banana.ay = 500
tiles.placeOnTile(Banana, tiles.getTileLocation(16, 1))
Banana.setVelocity(30, 0)
